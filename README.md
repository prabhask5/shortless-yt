...
- Google OAuth sign-in for a personalized experience
- **My Curated Feed** — signed-in home page showing a weighted-random mix of videos from across your entire subscription history (not just the most recent uploads). Rebuilt monthly, starts at a different random offset on every visit
- **Subscriptions** — chronological k-way merge of all your subscribed channels' recent uploads, with infinite scroll
- **Liked Videos** and **My Playlists** pages
...
- **No watch history**: The app does not track what you watch.
