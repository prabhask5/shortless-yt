 ...
 * Assembles dist-chrome/ and dist-firefox/ from compiled TypeScript + source files
 * + browser-specific manifests.
 *
 * TypeScript files in src/ are compiled to compiled/ by tsc, then the build
 * copies the resulting .js files along with .css and .json from src/.
 *
 * Usage:
...
// JS files come from compiled/, CSS/JSON from src/
const filesToCopy = [
	{ file: 'shortless.css', from: srcDir },
	{ file: 'shortless.js', from: compiledDir },
	{ file: 'background.js', from: compiledDir },
	{ file: 'rules.json', from: srcDir }
];
...
function buildTarget(target) {
	...
	for (const { file, from } of filesToCopy) {
