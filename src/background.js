/**
 * @file background.js — Service worker for the Shortless YouTube extension.
 *
 * This is intentionally minimal. All heavy lifting is done by:
 *   - shortless.js (content script) — DOM cleanup and SPA navigation interception
 ...
 *
 * @param {chrome.runtime.InstalledDetails} details — Contains the reason for
 *   the event: "install", "update", or "chrome_update".
 */
